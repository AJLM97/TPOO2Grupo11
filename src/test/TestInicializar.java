...
public class TestInicializar {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            festivalA = fABM.traerFestival(idFestival);
		...
		try {
			...
			System.out.printf("Id Festival: %d", idFestival);
            festivalB = fABM.traerFestival(idFestival);
		...
		try {
			...
			System.out.printf("Id Festival: %d", idFestival);
            festivalC = fABM.traerFestival(idFestival);
        ...
        try {
            ...
            empleadoA = eABM.traerEmpleado(idEmpleado);
        ...
        try {
            ...
            empleadoB = eABM.traerEmpleado(idEmpleado);
        ...
        try {
            ...
            System.out.printf("Id Empleado: %d", idEmpleado);
            empleadoC = eABM.traerEmpleado(idEmpleado);
        ...
        try {
            ...
            System.out.printf("Id Cocinero: %d", idEmpleado);
            empleadoD = eABM.traerEmpleado(idEmpleado);
        ...
        try {
            ...
            System.out.printf("Id Empleado: %d", idEmpleado);
            empleadoE = eABM.traerEmpleado(idEmpleado);
        ...
        try {
            ...
            System.out.printf("Id Empleado: %d", idEmpleado);
            empleadoF = eABM.traerEmpleado(idEmpleado);
        ...
        try {
            ...
            System.out.printf("Id Cocinero: %d", idEmpleado);
            empleadoG = eABM.traerEmpleado(idEmpleado);
        } catch(Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.printf("Id Empleado: %d", idEmpleado);
            empleadoH = eABM.traerEmpleado(idEmpleado);
        } catch(Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.printf("Id Cocinero: %d", idEmpleado);
            empleadoI = eABM.traerEmpleado(idEmpleado);
        } catch(Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.printf("Id Empleado: %d", idEmpleado);
            empleadoJ = eABM.traerEmpleado(idEmpleado);
        } catch(Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.printf("Id Cocinero: %d", idEmpleado);
            empleadoK = eABM.traerEmpleado(idEmpleado);
        } catch(Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.printf("Id Empleado: %d", idEmpleado);
            empleadoL = eABM.traerEmpleado(idEmpleado);
        } catch(Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            platoA = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoB = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoC = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoD = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoE = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoF = platoABM.traerPlato(idPlato);
		...
		try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoG = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoH = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoI = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoJ = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoK = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoL = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoM = platoABM.traerPlato(idPlato);
        ...
        try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoN = platoABM.traerPlato(idPlato);
		...
		try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoO = platoABM.traerPlato(idPlato);
		...
		try {
			...
			System.out.printf("Id Plato: %d", idPlato);
            platoP = platoABM.traerPlato(idPlato);
        ...
        try {
            ...
            System.out.printf("Id Plato: %d", idPlato);
            platoR = platoABM.traerPlato(idPlato);
        } catch(Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.printf("Id Plato: %d", idPlato);
            platoS = platoABM.traerPlato(idPlato);
        } catch(Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            System.out.printf("Id Plato: %d", idPlato);
            platoT = platoABM.traerPlato(idPlato);
        } catch(Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            unidadVentaA = (PuestoDesarmable) uABM.traerUnidadVenta(idUnidadVenta);
        ...
        try {
            ...
            unidadVentaB = (FoodTruck) uABM.traerUnidadVenta(idUnidadVenta);
		...
		try {
			...
			System.out.printf("Id FoodTruck: %d", idUnidadVenta);
            unidadVentaC = (FoodTruck) uABM.traerUnidadVenta(idUnidadVenta);
        ...
        try {
            ...
            Pedido pedido = peABM.traerPedido(idPedido);
            ...
            pedido = peABM.traerPedido(idPedido);
